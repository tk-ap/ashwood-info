(() => {
  ...
  style.textContent = `
    ...
    .v3-provenance-reveal{flex-basis:100%;display:flex;flex-wrap:wrap;align-items:baseline;gap:.28em;max-height:0;margin:0;overflow:hidden;opacity:0;transform:translateY(-4px);transition:max-height .4s ease,opacity .3s ease,transform .35s ease;color:inherit;font:inherit;line-height:inherit;letter-spacing:inherit}
    .v3-provenance-reveal.is-open{max-height:180px;margin-top:.18em;opacity:1;transform:none}
    .v3-provenance-reveal__label{color:var(--ashwood-field-green)}
    .v3-provenance-reveal__throughline{color:inherit}
    ...
    @media(max-width:760px){.v3-identity{display:block}.v3-identity-origin,.v3-manifestations{display:inline}.v3-provenance-reveal{display:block}.v3-provenance-reveal.is-open{max-height:240px}.v3-manifestations{min-width:0}}
