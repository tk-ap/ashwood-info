...
export const DECISIONS = [
  {
    ...
    change: "Six intentional views (Today, Build, Career, Evidence, Self) behind one persistent navigation instead of a long mixed page; Relationships/Network is nested inside Work.",
  ...
  },
  {
    ...
    design_refs: [{ repo: ASHWOOD, number: 153, kind: "issue" }],
    live: WORKSPACE_LIVE,
  ...
  {
    id: "ASH-WS-NOTIFICATIONS", product: "ASHWOOD", surface: "Workspace · Build",
  ...
  },
  {
    ...
    title: "Self as context intelligence for the ecosystem",
    reference: "21st.dev Bento composition",
    change: "Synthesize how TK is wired, current context, recurring patterns and tensions, then translate that context into explicit system behavior; manual input is secondary correction.",
    regression: "Existing goals, check-ins and frame data remain available while the primary Self surface stays synthesis-first.",
    design_refs: [{ repo: ASHWOOD, number: 153, kind: "issue" }],
    live: WORKSPACE_LIVE,
    paths: ["workspace/frame.mjs", "workspace/workspace.css"],
  },
  {
    id: "ASH-WS-CAREER-IN-WORK", product: "ASHWOOD", surface: "Workspace · Career",
    title: "Career Ops anchors Career",
    reference: "Information architecture (six-view cohesion)",
    change: "Career Ops, applications, opportunities and professional Relationships render together inside Career.",
  ...
  {
    id: "ASH-WS-LIST-DETAIL", product: "ASHWOOD", surface: "Workspace · Career",
    title: "Career uses list / detail in place",
    reference: "21st.dev list-detail pattern",
    change: "Applications and Relationships use in-place list/detail inside Career; Relationships no longer owns a primary navigation view.",
